...
do -- Example UI
	local Window = library:AddWindow("Furk - Mining Simulator 2", {
		main_color = Color3.fromRGB(0, 0, 0),
		min_size = Vector2.new(300, 180),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
...
for i,v in pairs(supported_games) do 
    if game.PlaceId == v then 
		...
		Tab:AddButton("Zeerox GUI", function()
